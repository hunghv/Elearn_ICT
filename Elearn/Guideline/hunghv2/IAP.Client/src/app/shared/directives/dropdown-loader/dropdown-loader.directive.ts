...
import { AfterViewChecked, OnInit, OnChanges } from '@angular/core/src/metadata/lifecycle_hooks';
...
export class DropdownLoaderDirective implements OnInit, OnChanges {
